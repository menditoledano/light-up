...
('הדלקת נרות חנוכה', 'מרץ 2024', 'תמונה של הרמת כוסית קהילתית לפסח במשרדי החברה', 1),
('חלוקת נרות חנוכה לכל עובד', 'דצמבר 2023', 'תמונה של הדלקת נרות חנוכה משותפת בלובי המשרדים', 2'),
('חלוקת מצה שמורה', 'ינואר 2024', 'תמונה של מפגש נטוורקינג לעובדים במתחם העבודה', 3');
